...
1. **下载安装**  
   从 [Releases](https://github.com/franj/PhoneMic/releases) 页面下载最新的 `PhoneMic_Setup.exe` 并运行安装。
...
前往 [Releases](https://github.com/franj/PhoneMic/releases) 下载最新的 `PhoneMic_Setup.exe`，双击运行即可完成安装。
...
- 项目主页：[GitHub](https://github.com/franj/PhoneMic)
- 报告问题：[Issues](https://github.com/franj/PhoneMic/issues)
